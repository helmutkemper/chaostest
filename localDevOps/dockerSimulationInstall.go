...
func dockerSimulationInstall(
	...
	simulation.SetGitPathPrivateRepository("github.com/helmutkemper")
	...
	err = simulation.AddFileOrFolderToLinkBetweenComputerHostAndContainer(memoryInputPath, "/memory_container")
	if err != nil {
		util.TraceToLog()
		log.Printf("Error: %v", err.Error())
		return
