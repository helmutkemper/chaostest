...
import (
	...
	"encoding/json"
	"errors"
	"github.com/helmutkemper/chaostest/dataTest"
	"github.com/helmutkemper/chaostest/support/debeziumSimulation"
	"github.com/helmutkemper/chaostest/support/messagingSystemNats"
...
func TestLocalDevOps(t *testing.T) {
	...
	var simulation = make([]*dockerBuilder.ContainerBuilder, KTotal)
	for i := int64(0); i != KTotal; i += 1 {
